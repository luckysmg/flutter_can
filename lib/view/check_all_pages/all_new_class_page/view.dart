...
Widget buildView(
    AllNewClassState state, Dispatch dispatch, ViewService viewService) {
  var body;
  if (state.hasNetworkError) {
    ...
    body = SmartRefresher(
      ...
      onLoading: () => dispatch(AllNewClassActionCreator.loadMore()),
...
Widget _item(AllNewClassState state, Dispatch dispatch, BuildContext context,
    int index) {
