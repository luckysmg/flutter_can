...
Widget buildView(
    AllClassicalClassState state, Dispatch dispatch, ViewService viewService) {
  var body;
  if (state.hasNetworkError) {
    ...
    body = SmartRefresher(
      ...
      onLoading: () => dispatch(AllClassicalClassActionCreator.loadMore()),
...
Widget _item(AllClassicalClassState state, Dispatch dispatch,
